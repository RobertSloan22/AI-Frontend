...
const InvoiceApt = () => {
    ...
    const stats = [
        ...
        { 
            ...
            value: serviceRecords.filter(r => r.status !== 'billed').length, 
            icon: '🚗' 
        },
        { 
    ...
    return (
        ...
        <Box sx={{
            ...
            gridTemplateRows: '10vh 25vh 10vh',
            gap: 2,
            padding: 2
          }}>
            ...
            <Box sx={{ gridColumn: '1 / span 4', gridRow: '1' }}>
                    <div className="bg-gray-800 rounded-lg p-6  h-[35vh] overflow-y-auto">
            ...
            <Box sx={{ gridColumn: '1 / span 4', gridRow: '3 / span 2' }}>
                    <InvoiceList />
            </Box>
            <Box sx={{ gridColumn: '5 / span 8', gridRow: '2 / span 2' }}>
                    <Activant />
            </Box>         
            ...
            {/* Stats Grid Section */}
            <Box sx={{ gridColumn: '5/ span 8', gridRow: '1' }}>
                <Item>
                    <div className="grid grid-cols-5 gap-4 sticky ">
