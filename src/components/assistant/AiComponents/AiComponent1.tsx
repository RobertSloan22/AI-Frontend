...
import axiosInstance from '../../lib/utils/axiosConfig.js';
      ...
      <div className="content-main h-[15vh]">
        <div className="content-logs">
          <div className="content-block eventsh-[10vh]">
            ...
            <div className="content-block-body h-[15vh]" style={{ width: '40vw' }} ref={eventsScrollRef}>
