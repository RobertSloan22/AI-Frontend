        ...
        <div className="space-y-6">
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="mb-4 p-4 bg-gray-800 bg-opacity-80 rounded-lg border-l-4 border-blue-500">
                    <h3 className="text-3xl font-semibold text-blue-400 mb-4">Customer Information</h3>
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            <label className="block text-gray-300 mb-1 text-2xl">Customer Name</label>
                            <input
                                type="text"
                                name="customerName"
                                value={formData.customerName}
                                onChange={handleChange}
                                className="w-full p-2 bg-gray-700 border-gray-600 text-white rounded-lg text-xl"
                                required
                            />
                        </div>
                        <div>
                            <label className="block text-gray-300 mb-1 text-xl">Email</label>
                            <input
                                type="email"
                                name="customerEmail"
                        ...
                        <div>
                            <label className="block text-gray-300 mb-1 text-xl">Phone</label>
                            <input
                                type="tel"
                                name="phoneNumber"
                        ...
                        <div>
                            <label className="block text-gray-300 mb-1 text-xl">Address</label>
                            <input
                                type="text"
                                name="address"
                ...
                <div className="mb-4 p-4 bg-gray-800 bg-opacity-80 rounded-lg border-l-4 border-green-500">
                    <h3 className="text-2xl font-semibold text-green-400 mb-4">Vehicle Selection</h3>
                    <select
                        className="w-full p-2 bg-gray-700 border-gray-600 text-white rounded-lg text-xl"
                    ...
                    {formData.vehicleId && (
                        <div className="mt-4 grid grid-cols-2 gap-4">
                            <div>
                                <label className="block text-gray-300 text-xl">Year/Make/Model</label>
                                <p className="text-white text-xl">{formData.vehicleYear} {formData.vehicleMake} {formData.vehicleModel}</p>
                            </div>
                            <div>
                                <label className="block text-gray-300 text-xl">VIN</label>
                                <p className="text-white text-xl">{formData.vehicleVin}</p>
                            </div>
                            <div>
                                <label className="block text-gray-300 text-xl">Mileage</label>
                                <p className="text-white text-xl">{formData.vehicleMileage}</p>
                            </div>
                            <div>
                                <label className="block text-gray-300 text-xl">Engine</label>
                                <p className="text-white text-xl">{formData.vehicleEngine}</p>
                            </div>
                        </div>
                    )}
                </div>
                ...
                <div className="mb-4 p-4 bg-gray-800 bg-opacity-80 rounded-lg border-l-4 border-yellow-500">
                    <h3 className="text-2xl font-semibold text-yellow-400 mb-4">Labor</h3>
                    <div className="space-y-4">
                        <div className="grid grid-cols-12 gap-2">
                            <input
                                ...
                                className="col-span-6 p-2 bg-gray-700 border-gray-600 text-white rounded-lg text-xl"
                            />
                            <input
                                type="number"
                                ...
                                placeholder="Hours"
                                className="col-span-2 p-2 bg-gray-700 border-gray-600 text-white rounded-lg text-xl"
                            />
                            <input
                                type="number"
                            ...
                            <button
                                ...
                                className="col-span-2 bg-yellow-500 hover:bg-yellow-600 text-white rounded-lg transition-colors text-xl"
                            >
                                Add Labor
                            </button>
                        </div>
                        ...
                        {formData.laborItems.map((item, index) => (
                            <div key={index} className="grid grid-cols-12 gap-2 items-center bg-gray-700 p-2 rounded-lg">
                                <span className="col-span-6 text-white text-xl">{item.description}</span>
                                <span className="col-span-2 text-white text-xl">{item.hours} hrs</span>
                                <span className="col-span-2 text-white text-xl">${item.ratePerHour}/hr</span>
                                <span className="col-span-1 text-white text-xl">${item.hours * item.ratePerHour}</span>
                                <button
                                    type="button"
                                    onClick={() => handleRemoveLaborItem(index)}
                                    className="col-span-1 text-red-500 hover:text-red-600 text-xl"
                                >
                                    ✕
                                </button>
                            </div>
                    ...
                    <div className="space-y-4">
                        <div className="grid grid-cols-12 gap-2">
                            ...
                            <input
                                ...
                                placeholder="Description"
                                className="col-span-4 p-2 bg-gray-700 border-gray-600 text-white rounded-lg text-xl"
                            />
                            <input
                                type="number"
                            ...
                            <button
                                ...
                                className="col-span-2 bg-purple-500 hover:bg-purple-600 text-white rounded-lg transition-colors text-xl"
                            >
                                Add Part
                            </button>
                        </div>
                        ...
                        {formData.partsItems.map((item, index) => (
                            <div key={index} className="grid grid-cols-12 gap-2 items-center bg-gray-700 p-2 rounded-lg">
                                <span className="col-span-2 text-white text-xl">{item.partNumber}</span>
                                <span className="col-span-4 text-white text-xl">{item.description}</span>
                                <span className="col-span-2 text-white text-xl">x{item.quantity}</span>
                                <span className="col-span-2 text-white text-xl">${item.price}</span>
                                <span className="col-span-1 text-white text-xl">${item.quantity * item.price}</span>
                                <button
                                    type="button"
                ...
                {/* Totals Section */}
                <div className="mb-4 p-4 bg-gray-800 bg-opacity-80 rounded-lg border-l-4 border-blue-500">
                    <div className="grid grid-cols-2 gap-4 text-white text-xl">
                    ...
                    <div className="flex justify-between items-center">
                        <div className="space-x-4">
                            <button
                                ...
                                className={`px-4 py-2 rounded-lg transition-colors text-xl ${formData.status === 'draft' ? 'bg-yellow-600' : 'bg-gray-600 hover:bg-gray-500'}`}
                            >
                                Draft
                            </button>
                            <button
                                ...
                                className={`px-4 py-2 rounded-lg transition-colors text-lg ${formData.status === 'completed' ? 'bg-green-600' : 'bg-gray-600 hover:bg-gray-500'}`}
                            >
                                Complete
                            </button>
                            <button
                                ...
                                className={`px-4 py-2 rounded-lg transition-colors text-xl ${formData.status === 'billed' ? 'bg-blue-600' : 'bg-gray-600 hover:bg-gray-500'}`}
                            >
                                Billed
                            </button>
                        </div>
                        <button
                            type="submit"
                            className="px-6 py-2 bg-blue-500 hover:bg-blue-600 text-white rounded-lg transition-colors text-xl"
                        >
                            Save Invoice
                        </button>
                    </div>
